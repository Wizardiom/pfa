...
int main()
{
  ...
  I1 = integrate_dx(f, 1, 2, 0.5, &qf);
  printf("%f\n", I1);
  printf("Right : \n");
  setQuadFormula(&qf, "right");
  I2 = integrate_dx(f, 1, 2, 0.5, &qf);
  printf("%f\n", I2);
  printf("Middle : \n");
  setQuadFormula(&qf, "middle");
  I3 = integrate_dx(f, 1, 2, 0.5, &qf);
  printf("%f\n", I3);
  printf("Trapezes : \n");
  setQuadFormula(&qf, "trapezes");
  I4 = integrate_dx(f, 1, 2, 0.5, &qf);
  printf("%f\n", I4);
  printf("Simpson : \n");
  setQuadFormula(&qf, "simpson");
  I5 = integrate_dx(f, 1, 2, 0.5, &qf);
  printf("%f\n", I5);
  printf("Gauss2 : \n");
  setQuadFormula(&qf, "gauss2");
  I6 = integrate_dx(f, 1, 2, 0.5, &qf);
  printf("%f\n", I6);
  printf("Gauss3 : \n");
  setQuadFormula(&qf, "gauss3");
  I7 = integrate_dx(f, 1, 2, 0.5, &qf);
  printf("%f\n", I7);
}
